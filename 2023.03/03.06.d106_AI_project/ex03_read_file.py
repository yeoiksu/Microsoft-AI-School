...
LABEL_NAME = 'military drone' # drone, bird, airplane, helicopter, balloon
...
# 경로 변경 필요 - 본인 작업 환경에 맞는 작업 경로
root_path = f"C:\\Users\\user\\Pictures\\bbox\\final"
new_root = f"C:\\Users\\user\\Pictures\\bbox\\{LABEL_NAME}"

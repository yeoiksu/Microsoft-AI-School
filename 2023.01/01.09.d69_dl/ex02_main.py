...
def main():    
    ...
    train_dataset = CustomDataset("./2023.01/01.06.d68_dl/dataset/train" , transform= train_aug)
    valid_dataset = CustomDataset("./2023.01/01.06.d68_dl/dataset/valid" , transform= valid_aug)
    test_dataset  = CustomDataset("./2023.01/01.06.d68_dl/dataset/test"  , transform= valid_aug)

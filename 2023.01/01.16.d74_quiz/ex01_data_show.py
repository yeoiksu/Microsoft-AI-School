...
image_show("./0116/previous_data")  ## 경로 변경 필요 !!!!!!!!!!!!
image_show("./0116/raw_data")  ## 경로 변경 필요 !!!!!!!!!!!!
# image_show("./0116/dataset/train")
# image_show("./0116/dataset/val")
# image_show("./0116/dataset/test")

...
image_show("./0113/previous_data")  ## 경로 변경 필요 !!!!!!!!!!!!
image_show("./0113/raw_data")  ## 경로 변경 필요 !!!!!!!!!!!!
# image_show("./0113/dataset/train")
# image_show("./0113/dataset/val")
# image_show("./0113/dataset/test")

...
class AnimalLabelDataset(CocoDataset): # Coco Dataset을 상속받음
    # Class 이름 변경 필요
    CLASSES = (
        "cat", 
        "chicken", 
...
# Model Load
checkpoint_file = "./work_dirs/0131/latest.pth"
...
for img_info in image_info['images'] :
    ...
    for number, result in enumerate(results) :
        ...
        for i in range(len(result_filtered)) :
            ...
            cv2.putText(image_resize, label_dict[int(tmp_dict['category_id'])],
                        (int(x1), int(y1 - 5)),

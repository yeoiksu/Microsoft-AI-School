## 주성분을 사용해 특성 줄이기
## sckitlearn 손글씨 데이터를 활용하여 특성 행렬을 표준화 처리 및 주성분 특성 줄이기
...
## digit data불러오기
digits = datasets.load_digits() # 8 X 8 크기의 손글씨 숫자 데이터 로드
...
## 주성분에 투영된 처음 두개의 특성을 사용하여 산점도 출력
...
## numpy allclose()를 사용하여 featrues_nowhiten 배열과 동일한지 확인

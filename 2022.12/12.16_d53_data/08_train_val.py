...
# dataset
train_dataset = catvsdogDataset("./2022.12/12.16_d53_data/data/dataset/train/", transform=train_transform)
val_dataset = catvsdogDataset("./2022.12/12.16_d53_data/data/dataset/val/", transform=val_transform)

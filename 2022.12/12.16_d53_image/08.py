...
# dataset
train_dataset = catvsdogDataset("./2022.12/12.16_d53_image/data/dataset/train/", transform=train_transform)
val_dataset = catvsdogDataset("./2022.12/12.16_d53_image/data/dataset/val/", transform=val_transform)
...
# model loader
model = models.__dict__[params["model"]](pretrainiksued=True)

...
img_path_list = image_file("./2022.12/12.13_d50_image/data/banana/images/")
...
for img_path in img_path_list:
    ...
    os.makedirs("./2022.12/12.13_d50_image/data/banana/images/resize", exist_ok=True)
    img_new.save(f"./2022.12/12.13_d50_image/data/banana/images/resize/{image_name}.png", quality=100)
